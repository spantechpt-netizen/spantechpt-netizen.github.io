...
export const DICT = {
  ar: {
    ...
    duct_type: 'نوع الجرايات', duct_steel: 'صاج مجلفن', duct_plastic: 'بلاستيك (HDPE)',
    duct_hint: 'بيتغيّر في بند التوريد في العرض المطبوع. مصر بلاستيك، وباقي الدول صاج.',
    labour_scope: 'العمالة', labour_spantech: 'علينا (سبان تك)', labour_client: 'على العميل',
    labour_scope_hint: 'لو علينا بند العمالة بيتكتب في نطاق شغلنا، ولو على العميل بيتنقل لمتطلبات المقاول الرئيسي.',
    labour_priced_warning: 'العمالة على العميل ولسه محسوبة في التكلفة — راجع تكلفة العمالة /م².',
    location: 'الموقع', location_ar: 'الموقع بالعربي',
    attention: 'عناية المهندس', attention_ar: 'عناية المهندس بالعربي',
    ...
    design_style: 'شكل العرض', design_hint: 'كل شكل ليه نصوصه المعدّلة الخاصة بيه؛ غيّر الشكل وافتح المطبوع عشان تشوفه.',
    ...
    desktop_needs_https: 'إشعارات سطح المكتب محتاجة HTTPS',
    capture_add: 'ضيف طلب من واتساب',
    capture_title: 'طلب جات على الواتساب',
    capture_share_needs_https: 'المشاركة المباشرة من الواتساب محتاجة HTTPS — اللصق شغال عادي.',
    ...
    not_found: 'مش موجود', days: 'يوم',
    study_inputs: 'بيانات الدراسة', study_result: 'نتيجة المقارنة', study_drawings: 'المخططات',
    study_project: 'المشروع',
    study_system: 'النظام التقليدي للمقارنة',
    study_system_hint: 'اختار النظام اللي كان المشروع هيتنفذ بيه أصلاً.',
    study_floors: 'عدد الأدوار', study_area: 'مساحة السقف للدور (م²)',
    study_area_hint: 'جاية من عرض السعر، وتقدر تعدلها.',
    study_slabs: 'الأسقف',
    study_conv_thickness: 'سُمك السقف التقليدي (مم)', study_pt_thickness: 'سُمك سقف البوست تنشن (مم)',
    study_conv_rebar: 'كثافة حديد التقليدي (كجم/م³)', study_pt_rebar: 'كثافة حديد البوست تنشن (كجم/م³)',
    study_rates: 'الأسعار',
    study_concrete_rate: 'سعر الخرسانة للمتر المكعب', study_rebar_rate: 'سعر الحديد للطن',
    study_formwork_rate: 'سعر الشدات للمتر المربع', study_pt_rate: 'سعر البوست تنشن للمتر المربع',
    study_pt_rate_hint: 'بيتاخد من عرض السعر نفسه.',
    study_beyond: 'وفر بره السقف',
    study_beyond_hint: 'دي تقديراتك انت للمشروع ده: اللي بيتوفر في الأساسات والأعمدة، وقيمة اليوم اللي بيتكسب من البرنامج الزمني.',
    study_foundation_saving: 'وفر الأساسات والأعمدة للمتر المربع', study_day_value: 'قيمة اليوم الواحد',
    study_conv_cycle: 'مدة دور التقليدي (يوم)', study_pt_cycle: 'مدة دور البوست تنشن (يوم)',
    study_notes_ar: 'ملاحظات بالعربي', study_notes_en: 'ملاحظات بالإنجليزي',
    study_incomplete: 'الدراسة لسه ناقصة:',
    study_concrete_rate_m3: 'سعر الخرسانة', study_rebar_rate_ton: 'سعر الحديد',
    study_pt_rate_sqm: 'سعر البوست تنشن', study_area_sqm: 'المساحة',
    study_per_sqm: 'للمتر المربع', study_pt: 'البوست تنشن',
    study_concrete: 'الخرسانة', study_rebar: 'حديد التسليح', study_formwork: 'الشدات',
    study_pt_package: 'أعمال الشد اللاحق',
    study_slab_only: 'فرق تكلفة الأسقف', study_whole_building: 'صافي الوفر على المشروع',
    study_slab_negative: 'على مستوى السقف وحده البوست تنشن أغلى في الحالة دي، والوفر بييجي من الأساسات والأعمدة ومدة التنفيذ.',
    study_breakdown: 'مصادر الوفر', study_programme: 'وفر مدة التنفيذ', study_benefits: 'مكاسب إضافية',
    study_concrete_saved: 'خرسانة موفَّرة', study_rebar_saved: 'حديد موفَّر',
    study_weight_saved: 'تخفيف وزن المبنى', study_thickness_saved: 'تقليل سُمك السقف',
    study_height_saved: 'ارتفاع موفَّر على المبنى', study_days_saved: 'اختصار في المدة',
    study_drawings_hint: 'ارفع المخططات الأصلية للمشروع ومخططات البوست تنشن بتاعتنا — هتظهر جوه الدراسة المطبوعة. صور PNG أو JPG أو WebP.',
  ...
  en: {
    ...
    duct_type: 'Duct material', duct_steel: 'Galvanized steel', duct_plastic: 'Plastic (HDPE)',
    duct_hint: 'Changes the supply line on the printed offer. Egypt is plastic, the other markets steel.',
    labour_scope: 'Installation labour', labour_spantech: 'Ours (Span Tech)', labour_client: 'The client’s',
    labour_scope_hint: 'Ours prints the labour line under our scope of work; the client’s moves it to the main contractor’s requirements.',
    labour_priced_warning: 'The client supplies the labour, but it is still costed here — check the labour cost per m².',
    location: 'Location', location_ar: 'Location (Arabic)',
    attention: 'Attention', attention_ar: 'Attention (Arabic)',
    ...
    design_style: 'Layout', design_hint: 'Each layout keeps its own edited wording; switch and open the print to see it.',
    ...
    desktop_needs_https: 'Desktop alerts need HTTPS',
    capture_add: 'Add a WhatsApp request',
    capture_title: 'Request from WhatsApp',
    capture_share_needs_https: 'Sharing straight from WhatsApp needs HTTPS — pasting works either way.',
    ...
    not_found: 'Not found', days: 'days',
    study_inputs: 'Study inputs', study_result: 'Result', study_drawings: 'Drawings',
    study_project: 'Project',
    study_system: 'Conventional system to compare',
    study_system_hint: 'The system the project would otherwise have been built in.',
    study_floors: 'Number of floors', study_area: 'Slab area per floor (m²)',
    study_area_hint: 'Taken from the quotation; you can change it.',
    study_slabs: 'Slabs',
    study_conv_thickness: 'Conventional slab thickness (mm)', study_pt_thickness: 'Post-tensioned thickness (mm)',
    study_conv_rebar: 'Conventional reinforcement (kg/m³)', study_pt_rebar: 'Post-tensioned reinforcement (kg/m³)',
    study_rates: 'Rates',
    study_concrete_rate: 'Concrete per m³', study_rebar_rate: 'Reinforcement per tonne',
    study_formwork_rate: 'Formwork per m²', study_pt_rate: 'Post-tensioning per m²',
    study_pt_rate_hint: 'Taken from the quotation itself.',
    study_beyond: 'Beyond the slab',
    study_beyond_hint: 'Your own estimate for this project: what the lighter structure saves in foundations and columns, and what a day off the programme is worth.',
    study_foundation_saving: 'Foundations and columns saved per m²', study_day_value: 'Value of one day',
    study_conv_cycle: 'Conventional cycle per floor (days)', study_pt_cycle: 'Post-tensioned cycle per floor (days)',
    study_notes_ar: 'Notes (Arabic)', study_notes_en: 'Notes (English)',
    study_incomplete: 'The study is not complete yet:',
    study_concrete_rate_m3: 'concrete rate', study_rebar_rate_ton: 'reinforcement rate',
    study_pt_rate_sqm: 'post-tensioning rate', study_area_sqm: 'area',
    study_per_sqm: 'Per m²', study_pt: 'Post-tensioned',
    study_concrete: 'Concrete', study_rebar: 'Reinforcement', study_formwork: 'Formwork',
    study_pt_package: 'Post-tensioning package',
    study_slab_only: 'Slab cost difference', study_whole_building: 'Net saving on the project',
    study_slab_negative: 'On slab cost alone the post-tensioned option is dearer here; the saving comes from the foundations, the columns and the programme.',
    study_breakdown: 'Where the saving comes from', study_programme: 'Programme saving', study_benefits: 'Further gains',
    study_concrete_saved: 'Concrete saved', study_rebar_saved: 'Reinforcement saved',
    study_weight_saved: 'Building weight removed', study_thickness_saved: 'Slab depth saved',
    study_height_saved: 'Height saved over the building', study_days_saved: 'Programme shortened by',
